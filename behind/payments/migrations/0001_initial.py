    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pg_response', django_mysql.models.JSONField(default=dict)),
                ('requested_at', models.DateTimeField(auto_now_add=True)),
                ('responded_at', models.DateTimeField()),
                ('status', models.SmallIntegerField(choices=[(0, 'standby'), (1, 'committed'), (2, 'staging'), (3, 'committing'), (20, 'canceled'), (-20, 'cancel_failed'), (-30, 'canceling'), (-1, 'failed'), (-2, 'commit_failed')], default=0)),
                ('authority', models.SmallIntegerField(choices=[(1, 'behind'), (2, 'pg')], default=2)),
